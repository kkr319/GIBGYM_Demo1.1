...
public class InitialFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_initial1, container, false);
        FragmentActivity fragmentActivity = this.getActivity();
        final ViewPager2 viewPager = fragmentActivity != null ? (ViewPager2)fragmentActivity.findViewById(R.id.viewPager) : null;


        ((TextView)view.findViewById(R.id.init_frag_next_btn_one)).setOnClickListener((View.OnClickListener)(new View.OnClickListener() {
